...
public class MovieAdapter extends ArrayAdapter<Movie>{
    ...
    public class ViewHolder{
        public TextView movieName, movieYear, movieAbout;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.movieImg = convertView.findViewById(R.id.movieAboutID);
        ...
        viewHolder.movieAbout.setText(movies.get(position).getMovieAbout());
